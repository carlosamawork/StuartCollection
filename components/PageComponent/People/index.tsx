                ...
                {activePerson.featuredImage && (
                  <div className={s.personDetailImage}>
                    <LazyImage
                      ...
                      alt={
                        activePerson.featuredImage.filename || activePerson.name || 'Person Image'
                      }
      ...
      <div className={`${s.people}`}>
        {data.listOfPeople &&
          data.listOfPeople.map((person: any, index: number) => (
            <div
              key={index}
              className={`${s.personCard} ${activePerson === person ? s.active : ''}`}
              onClick={() =>
                activePerson === person ? setActivePerson(null) : setActivePerson(person)
              }
            >
