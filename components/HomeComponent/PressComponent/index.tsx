...
export default function PressComponent({data}: {data: any}) {
  ...
  return (
    <div className={s.press}>
        <div className={s.topContent}>
            ...
            {data.cta && (
                <div className={`${s.ctaButton}`}>
                    <Link href={data.cta.href} className={s.ctaLink} target={data.cta.blank ? '_blank' : '_self'} rel={data.cta.blank ? 'noopener noreferrer' : undefined}>
        ...
        <div className={`${s.pressContent} ${data.options.columnsDesktop ? s[`columns${data.options.columnsDesktop}`] : ''}`}>
