    ...
    <div className={s.visit}>
      ...
      <div className={s.titleVisit}>
        ...
        <div className={`ctaButton ${s.ctaButton}`}>
            <Link href={data.cta.url} target={data.cta.newWindow ? '_blank' : '_self'} rel={data.cta.newWindow ? 'noopener noreferrer' : undefined}>{data.cta.title}</Link>
        </div>
      </div>
      <div className={s.contentVisit}>
        ...
        <div className={s.visitMedia}>
            ...
            <LazyVideo
                ...
                thumbnail={data.media.internalVideo.thumbnail ? data.media.internalVideo.thumbnail.imageUrl : undefined}
                muted={false}
                autoplay={false}
            /> : 
            data.media.type === 'youtube-vimeo-video' ?
            <VideoEmbed url={data.media.externalVideoUrl} /> : null
            }
        </div>
